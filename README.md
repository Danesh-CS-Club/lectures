...
### 3: Mastery of Git
**About:** Taking the typical knowledge of Git that a user may have, this advanced session covers topics that go further into deeper expert-level techniques professional developers rely on daily. Unlike simple basic commands, it involves interactive rebasing, advanced merging strategies, Git hooks to enable automation, submodules for large projects, and efficient workflows in team environments — equipping members to confidently and speedily handle complex repositories.

**Article:** https://github.com/Danesh-CS-Club/mastery-of-git  
**Recorded Conference:** [Coming soon]  
**Lecture given by:** [`Ryan Samaeian`](https://github.com/k1nxx)
...
**Recorded Conference:** [Coming soon]  
**Lecture given by:** [`Arman Jamshidi`](https://github.com/Armanj88)
